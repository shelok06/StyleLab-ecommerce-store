...
const Contact = () => {
  ...
  return (
    <>
      <Toaster />
      <div className='mx-5 sm:mx-10 my-10 px-2 sm:px-8'>
          ...
          <form action="" onSubmit={handleSubmit(handleForm)}>
            <div className='flex flex-col my-5 gap-2'>
              ...
              <input type="text" id="name" name='name' placeholder='Your full name e.g. John Doe'
                ...
                className='bg-gray-100 py-4 px-4 w-[80%] shadow-lg rounded-lg' />
            </div>
            ...
            <div className='flex flex-col my-5 gap-2'>
              ...
              <textarea id="name" name='name'
                ...
                className='bg-gray-100 py-4 px-4 w-[80%] shadow-lg rounded-lg'></textarea>
            </div>
